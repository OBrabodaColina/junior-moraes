...
export default function WhatsAppBtn({ text, className = '' }: WhatsAppBtnProps) {
  ...
  return (
    <a 
      ...
      className={`inline-flex items-center justify-center bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-md transition-colors duration-300 ${className}`}
    >
